...
import {QtyCtl,qty} from './QtyCtrl';
...
export default function MainPage_copy() {
...
// fetch brand data 
 ...
 const Slider=()=>{
  ...
  ///////////////////////////////////////// end of Slider ///////////////////////////////////////////////////////
      ...
      return (
        getListAd.map((item, key) => {
          ...
          return (
            ...
            <div>
              <div className={classes.cardroot} style={{background:`${colors[Math.floor((Math.random()*3))]}`}} >
                 <Avatar variant="rounded" className={classes.media} alt={item.categoryname} src={`${ServerURL}/images/${item.ad}`}/>
              </div>
    ...
    //              <Avatar variant="rounded" className={classes.media} alt={item.Productname} src={`${ServerURL}/images/${item.ad}`}/>
    //           </div>
    //           <div className={classes.text}>
    //                 {item.Productname}
    //               </div>
      ...
      <AppBar position="static" color="inherit">
       ...
       {/* show the slider */}
        ...
        <h1 className={classes.title_section}> Bestival Sale Top Offers </h1>
          <div className={classes.cardview} >
            <Productdataslider setCount={(v)=>setCount(v)} />
          </div>
        {/* end product item */}
